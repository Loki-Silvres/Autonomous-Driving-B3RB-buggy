...
def main():
    ...
    if cmd_input[1].lower() == "start":
        ...
        build = input("Do you want to build the packages? (y/N): ")
        if build.lower() == "y":
        ...
        ros_subprocess4=subprocess.Popen(["ros2 launch foxglove_bridge foxglove_bridge_launch.xml"],stdout=subprocess.DEVNULL,shell=True) #starting foxglove bridge
